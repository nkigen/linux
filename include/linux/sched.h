...
extern void get_avenrun (unsigned long *loads, unsigned long offset,
			 int shift);
...
extern char ___assert_task_state[1 -
				 2 * ! !(sizeof (TASK_STATE_TO_CHAR_STR) -
...
static inline void
touch_softlockup_watchdog_sync (void)
{
}
...
static inline int
signal_group_exit (const struct signal_struct *sig)
{
...
#else
static inline void
prefetch_stack (struct task_struct *t)
{
}
#endif
...
#else
static inline void
task_numa_fault (int last_node, int node, int pages, int flags)
{
}

static inline pid_t
task_numa_group_id (struct task_struct *p)
{
  return 0;
}
...
static inline void
task_numa_free (struct task_struct *p)
{
}
#endif
 ...
 */
static inline int
pid_alive (struct task_struct *p)
{
...
#else
static inline void
task_cputime (struct task_struct *t, cputime_t * utime, cputime_t * stime)
{
  if (utime)
    *utime = t->utime;
  if (stime)
...
static inline void
task_cputime_scaled (struct task_struct *t,
...
task_gtime (struct task_struct *t)
{
  return t->gtime;
}
#endif
extern void task_cputime_adjusted (struct task_struct *p, cputime_t * ut,
				   cputime_t * st);
extern void thread_group_cputime_adjusted (struct task_struct *p,
...
static inline void
tsk_restore_flags (struct task_struct *task,
...
#else
static inline void
do_set_cpus_allowed (struct task_struct *p, const struct cpumask *new_mask)
{
}

static inline int
set_cpus_allowed_ptr (struct task_struct *p, const struct cpumask *new_mask)
{
...
static inline int
set_cpus_allowed (struct task_struct *p, cpumask_t new_mask)
{
...
static inline void
sched_clock_idle_wakeup_event (u64 delta_ns)
{
}
#else
/*
...
static inline void
sched_autogroup_detach (struct task_struct *p)
{
}

static inline void
sched_autogroup_fork (struct signal_struct *sig)
{
}

static inline void
sched_autogroup_exit (struct signal_struct *sig)
{
}
#endif
...
static inline struct user_struct *
...
#else
static inline void
kick_process (struct task_struct *tsk)
{
}
#endif
...
static inline int
dequeue_signal_lock (struct task_struct *tsk, sigset_t * mask,
		     siginfo_t * info)
{
  unsigned long flags;
  int ret;
...
extern void __wake_up_parent (struct task_struct *p,
...
static inline unsigned long
wait_task_inactive (struct task_struct *p, long match_state)
{
  return 1;
}
#endif
...
static inline int
get_nr_threads (struct task_struct *tsk)
{
...
static inline void
unlock_task_sighand (struct task_struct *tsk, unsigned long *flags)
{
  spin_unlock_irqrestore (&tsk->sighand->siglock, *flags);
}
...
#ifdef CONFIG_CGROUPS
static inline void
threadgroup_change_begin (struct task_struct *tsk)
{
  down_read (&tsk->signal->group_rwsem);
}

static inline void
threadgroup_change_end (struct task_struct *tsk)
{
 ...
 */
static inline void
threadgroup_unlock (struct task_struct *tsk)
{
...
static inline unsigned long *
end_of_stack (struct task_struct *p)
{
...
static inline unsigned long
stack_not_used (struct task_struct *p)
{
...
#ifdef TS_POLLING
static inline int
tsk_is_polling (struct task_struct *p)
{
  return task_thread_info (p)->status & TS_POLLING;
}

static inline void
__current_set_polling (void)
{
...
void thread_group_cputimer (struct task_struct *tsk,
			    struct task_cputime *times);

static inline void
thread_group_cputime_init (struct signal_struct *sig)
{
...
static inline void
signal_wake_up (struct task_struct *t, bool resume)
{
...
static inline int
task_node (const struct task_struct *p)
{
...
static inline void
set_task_cpu (struct task_struct *p, unsigned int cpu)
{
}
...
static inline void
add_rchar (struct task_struct *tsk, ssize_t amt)
{
  tsk->ioac.rchar += amt;
}

static inline void
add_wchar (struct task_struct *tsk, ssize_t amt)
{
  tsk->ioac.wchar += amt;
}

static inline void
inc_syscr (struct task_struct *tsk)
{
  tsk->ioac.syscr++;
}

static inline void
inc_syscw (struct task_struct *tsk)
{
  tsk->ioac.syscw++;
}
#else
...
static inline void
mm_init_owner (struct mm_struct *mm, struct task_struct *p)
{
}
#endif /* CONFIG_MM_OWNER */

static inline unsigned long
task_rlimit (const struct task_struct *tsk, unsigned int limit)
{
  return ACCESS_ONCE (tsk->signal->rlim[limit].rlim_cur);
}

static inline unsigned long
task_rlimit_max (const struct task_struct *tsk, unsigned int limit)
{
